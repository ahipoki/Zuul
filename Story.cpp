...
void Talk::act(map<char*, Room*>* rm, Room** currentRoom, vector<Item*>* bag)
{
  ...
  if(strcmp((*currentRoom)->getTitle(), "High School -> Araragi House") == 0)
  {
    if(event[0] == false)
    {
      ...
      cout << "You start walking off and the girl chases after you to catch up." << endl;
